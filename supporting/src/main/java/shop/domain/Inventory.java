...
import shop.domain.InventroyIncreased;
...
public class Inventory {
    ...
    public void onPostPersist() {
        ...
        InventroyIncreased inventroyIncreased = new InventroyIncreased(this);
        inventroyIncreased.publishAfterCommit();
    }
    ...
    public static void increaseInventory(DeliveryCanceled deliveryCanceled) {
        ...
        InventroyIncreased inventroyIncreased = new InventroyIncreased(inventory);
        inventroyIncreased.publishAfterCommit();
        */
